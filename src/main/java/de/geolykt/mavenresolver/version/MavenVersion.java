...
public class MavenVersion implements Comparable<MavenVersion> {
    ...
    public static void testSplitTokens() {
        if (!Arrays.equals(splitTokens("1-").toArray(), new String[] {"1", "-"})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(splitTokens("1-final").toArray(), new String[] {"1", "-", "final"})) {
            throw new AssertionError(splitTokens("1-final"));
        }
        if (!Arrays.equals(splitTokens("1.0.2c0").toArray(), new String[] {"1", ".", "0", ".", "2", "-", "c", "-", "0"})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(splitTokens("1.-").toArray(), new String[] {"1", ".", "0", "-"})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(splitTokens(".").toArray(), new String[] {"0", "."})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(splitTokens("1.2-b0").toArray(), new String[] {"1", ".", "2", "-", "beta", "-", "0"})) {
            throw new AssertionError(splitTokens("1.2-b0"));
        }
        if (!Arrays.equals(splitTokens("1.2b0").toArray(), new String[] {"1", ".", "2", "-", "beta", "-", "0"})) {
            throw new AssertionError(splitTokens("1.2b0"));
        }
        if (!Arrays.equals(splitTokens("stausee").toArray(), new String[] {"stausee"})) {
            throw new AssertionError();
        }

        if (!Arrays.equals(purgeTokens(splitTokens("1-")).toArray(), new String[] {"1"})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(purgeTokens(splitTokens("1.2-final-.foo-ga")).toArray(), new String[] {"1", ".", "2", "-", "0", ".", "foo"})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(purgeTokens(splitTokens("1.2.3")).toArray(), new String[] {"1", ".", "2", ".", "3"})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(purgeTokens(splitTokens("1.2.3b")).toArray(), new String[] {"1", ".", "2", ".", "3", "-", "b"})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(purgeTokens(splitTokens("0")).toArray(), new String[] {})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(purgeTokens(splitTokens("final")).toArray(), new String[] {})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(purgeTokens(splitTokens("1.2b0")).toArray(), new String[] {"1", ".", "2", "-", "beta"})) {
            throw new AssertionError();
        }

        /// Test examples provided by maven
        if (!Arrays.equals(purgeTokens(splitTokens("1.0.0")).toArray(), new String[] {"1"})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(purgeTokens(splitTokens("1.ga")).toArray(), new String[] {"1"})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(purgeTokens(splitTokens("1.final")).toArray(), new String[] {"1"})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(purgeTokens(splitTokens("1.0")).toArray(), new String[] {"1"})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(purgeTokens(splitTokens("1.")).toArray(), new String[] {"1"})) {
            throw new AssertionError();
        ...
        if (!Arrays.equals(purgeTokens(splitTokens("1.0.0-foo.0.0")).toArray(), new String[] {"1", "-", "foo"})) {
            throw new AssertionError();
        }
        if (!Arrays.equals(purgeTokens(splitTokens("1.0.0-0.0.0")).toArray(), new String[] {"1"})) {
            throw new AssertionError();
        }
    }
